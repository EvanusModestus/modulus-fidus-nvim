-- ==============================================================================
-- MODULUS FIDUS - Hardened Neovim Configuration
-- ==============================================================================
-- Security-focused variant of modulus-nvim for enterprise/professional use
--
-- SECURITY MODIFICATIONS:
-- - Removed GitHub Copilot (sends code to external servers)
-- - Removed Obsidian plugins (personal note-taking, not enterprise-focused)
-- - Removed Markdown Preview and Glow (require external binaries/npm/browser)
-- - Removed Cellular Automaton (unnecessary for production)
-- - All plugin versions pinned for reproducibility
-- - lazy-lock.json committed to version control
-- ==============================================================================
...
local plugins = {
    ...
    -- REMOVED: 'github/copilot.vim' - Security: Sends code to GitHub servers
    -- REMOVED: 'eandrju/cellular-automaton.nvim' - Not needed for enterprise
    {
        'laytan/cloak.nvim',
    ...
    -- REMOVED: Markdown preview - Security: Requires npm install and browser access
    -- REMOVED: Glow markdown viewer - Requires external binary installation
    -- REMOVED: Obsidian plugins - Personal note-taking, not needed for enterprise
